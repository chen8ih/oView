...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    return h(this.tag, {
      class: ['okendo-row', this.justify !== 'start' ? 'is-justify-' + this.justify : '', this.align !== 'top' ? 'is-align-' + this.align : '', { 'okendo-row--flex': this.type === 'flex' }],
      style: this.style
    }, this.$slots.default);
  }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__row_vue__ = __webpack_require__(10);


__WEBPACK_IMPORTED_MODULE_0__row_vue__["a" /* default */].install = function (vue) {
  Vue.component(__WEBPACK_IMPORTED_MODULE_0__row_vue__["a" /* default */].name, __WEBPACK_IMPORTED_MODULE_0__row_vue__["a" /* default */]);
};

/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__row_vue__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_row_vue__ = __webpack_require__(7);
...
var update = __webpack_require__(4)("0df644ab", content, true, {});
...
// module
exports.push([module.i, ".utils-ellipsis{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.scroll-bar::-webkit-scrollbar{z-index:11;width:6px}.scroll-bar::-webkit-scrollbar:horizontal{height:6px}.scroll-bar::-webkit-scrollbar-thumb{border-radius:5px;width:6px;background:#b4bccc}.scroll-bar::-webkit-scrollbar--track,.scroll-bar::-webkit-scrollbar-corner{background:#fff}.scroll-bar::-webkit-scrollbar--track--piece{background:#fff;width:6px}.row{padding-left:5px;padding-right:5px;display:table;table-layout:fixed;width:100%}.cell,.wide-cell{display:table-cell;vertical-align:middle}.wide-cell{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:100%;padding-left:5px}.narrow-cell{display:table-cell;vertical-align:middle;width:16px;text-align:center;line-height:0}.okendo-row{position:relative;margin-left:0;margin-right:0;height:auto;zoom:1}.okendo-row:after,.okendo-row:before{content:\"\";display:table}.okendo-row:after{clear:both;visibility:hidden;font-size:0;height:0}.okendo-row--flex{display:-webkit-box;display:-ms-flexbox;display:flex}.okendo-row--flex:after,.okendo-row--flex:before{display:none}.is-justify-center{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.is-justify-end{-webkit-box-pack:end;-ms-flex-pack:end;justify-content:flex-end}.is-justify-space-between{-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}.is-justify-space-around{-ms-flex-pack:distribute;justify-content:space-around}.is-align-middle{-webkit-box-align:center;-ms-flex-align:center;align-items:center}.is-align-bottom{-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end}", ""]);
