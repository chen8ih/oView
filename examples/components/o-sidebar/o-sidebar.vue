...
<template>
  <div class="side-nav">
    <div v-for="(title, tdx) in (Object.keys(data))" :key="tdx" class="group-container">
      <p class="side-nav-title">{{title}}</p>
      <div class="side-nav-items" v-for="(nav, ndx) in data[title]" :key="ndx" v-if="nav.desc">
        ...
        <div v-for="(item, idx) in nav.items" :key="idx">
